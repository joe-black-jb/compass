...
export default function HeaderAll(props: Props) {
    ...
    <header className="fixed top-0 h-[50px] w-full z-10 bg-green-300">
      ...
      >
        <div className="flex lg:flex-1">
          {/* Circle Icon */}
          {/* <a href="/" className="-m-1.5 p-1.5 hover:bg-green-200 rounded-full">
            <img
              src={`${process.env.PUBLIC_URL}/compass-circle-green.png`}
              className="w-6 h-6 hover:bg-green-200"
              alt="Logo"
            />
          </a> */}
          <a
      ...
      <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen}>
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-10 w-[40%] overflow-y-auto bg-white sm:max-w-[300px] sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between p-2.5">
            ...
            <button
              type="button"
              className="-m-2.5 rounded-md pt-3.5 pr-10 sm:pr-12 md:pr-10 text-gray-700"
